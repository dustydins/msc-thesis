...
%-- challenge of lack of formal verification libraries for languages adopted by machine learning community.
...
% Some progress has been made recently, (sapphire, maribou).
...
%-- objectives
% implement a formal verification library for feed forward neural networks in Go
